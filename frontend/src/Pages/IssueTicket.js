...
const NFT_STORAGE_KEY = process.env.REACT_APP_NFT_KEY;
...
export default function IssueTicket() {
  ...
  const [loading, setLoading] = useState({ upload: false, mint: false, image: false });
  ...
  const uploadMetadata = async () => {
    if (!NFT_STORAGE_KEY) throw new Error('NFT Storage key is not configured');
